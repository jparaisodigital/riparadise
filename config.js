const CONFIG = {
    ...
    gallery: [
        ...
        { image: "assets/1 (2).webp",  size: "medium" },
        { image: "assets/1 (3).webp",  size: "small" },
        { image: "assets/1 (4).png",  size: "medium" },
        { image: "assets/1 (5).webp",  size: "small" },
        { image: "assets/1 (6).webp",  size: "small" },
        { image: "assets/1 (7).png",  size: "medium" },
        { image: "assets/1 (8).webp",  size: "small" },
        { image: "assets/1 (9).png",  size: "medium" },
        { image: "assets/1 (10).webp", size: "small" },
        { image: "assets/1 (11).png", size: "large" },
        { image: "assets/1 (12).webp", size: "large" },
        { image: "assets/1 (13).webp", size: "small" },
        { image: "assets/1 (14).webp", size: "medium" },
        { image: "assets/1 (15).webp", size: "small" },
        { image: "assets/1 (16).webp", size: "small" },
        { image: "assets/1 (17).webp", size: "medium" },
        { image: "assets/1 (18).webp", size: "small" },
        { image: "assets/1 (19).webp", size: "small" },
        { image: "assets/1 (20).webp", size: "small" },
        { image: "assets/1 (21).webp", size: "medium" },
        { image: "assets/1 (22).webp", size: "small" },
        { image: "assets/1 (23).webp", size: "small" },
        { image: "assets/1 (24).webp", size: "medium" },
        { image: "assets/1 (25).webp", size: "small" },
        { image: "assets/1 (26).webp", size: "small" },
        { image: "assets/1 (27).webp", size: "medium" },
        { image: "assets/1 (28).webp", size: "small" },
        { image: "assets/1 (29).webp", size: "small" },
        { image: "assets/1 (30).webp", size: "small" },
        { image: "assets/1 (31).webp", size: "medium" },
        { image: "assets/1 (32).webp", size: "small" },
        { image: "assets/1 (33).webp", size: "small" },
        { image: "assets/1 (34).webp", size: "medium" },
        { image: "assets/1 (35).webp", size: "small" },
        { image: "assets/1 (36).webp", size: "small" },
        { image: "assets/1 (37).webp", size: "medium" },
        { image: "assets/1 (38).webp", size: "small" },
        { image: "assets/1 (39).webp", size: "small" },
        { image: "assets/1 (40).webp", size: "medium" },
        { image: "assets/1 (41).webp", size: "small" },
        { image: "assets/1 (42).webp", size: "small" },
        { image: "assets/1 (43).webp", size: "medium" },
        { image: "assets/1 (44).webp", size: "small" },
        { image: "assets/1 (45).webp", size: "small" },
        { image: "assets/1 (46).webp", size: "medium" },
        { image: "assets/1 (47).webp", size: "small" },
        { image: "assets/1 (48).webp", size: "large" },
        { image: "assets/1 (49).webp", size: "medium" },
        { image: "assets/1 (50).webp", size: "small" },
        { image: "assets/1 (51).webp", size: "small" },
        { image: "assets/1 (52).webp", size: "small" },
        { image: "assets/1 (53).webp", size: "small" },
        { image: "assets/1 (54).webp", size: "large" },
        { image: "assets/1 (55).webp", size: "small" },
        { image: "assets/1 (56).webp", size: "medium" },
        { image: "assets/1 (57).webp", size: "small" },
        { image: "assets/1 (58).webp", size: "small" },
        { image: "assets/1 (59).webp", size: "medium" },
        { image: "assets/1 (60).webp", size: "large" },
        { image: "assets/1 (61).webp", size: "large" },
        { image: "assets/1 (62).webp", size: "small" },
        { image: "assets/1 (63).webp", size: "small" },
        { image: "assets/1 (64).webp", size: "small" },
        { image: "assets/1 (65).webp", size: "small" },
        { image: "assets/1 (66).webp", size: "medium" },
        { image: "assets/1 (67).webp", size: "small" },
        { image: "assets/1 (68).webp", size: "small" },
        { image: "assets/1 (69).webp", size: "small" },
        { image: "assets/1 (70).webp", size: "medium" },
        { image: "assets/1 (71).webp", size: "medium" },
        { image: "assets/1 (72).webp", size: "medium" },
        { image: "assets/1 (73).webp", size: "small" }
    ],
    ...
    footerThanks: {
        enabled: true,  
        backgroundImage: "assets/tomb.webp",
        coverImage: "assets/tomb.webp", 
        title: "RIP",
